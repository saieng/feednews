<template>
  ...
  >
    ...
    <div class="relative w-full aspect-video overflow-hidden">
      ...
      <!-- 新闻图片 -->
      <img 
        :src="news.image_url || news.image || '/api/placeholder/400/225'"
        :alt="news.title"
    ...
    <div class="p-6">
      <!-- 标题 - 最多2行 -->
      <h3 class="text-lg font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors leading-tight">
        {{ news.title }}
      </h3>
      ...
      <div class="flex items-center justify-between text-sm">
        ...
        <span class="text-blue-600 font-medium">
          By: {{ news.creator?.username || news.author || '未知作者' }}
        </span>
